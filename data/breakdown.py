...
labels = 'Network', 'Permutations', 'Forward Key Derivation & Decryption', 'Forward Noise', 'Backwards Re-Encrypt', 'Other'
sizes = [(network/total) * 100, (permute/total) * 100,
         (forward_dec/total) * 100, (forward_noise/total) * 100,
...
plt.legend(labels=new_labels, bbox_to_anchor=(1.5,0))
